...
LastEditTime: 2022-04-12 16:28:21
...
from .compression import TopkLayer,QSendLayerGPU,QRecvLayerGPU,SortQuantGPU,SortDeQuantGPU
...
def SendTensor(input,send_rank, self_rank,prune_layer = None, quant_layer = None,send_layer = None,sortquant = None,split = 0,bits = 0):
    ...
    return input
def RecvTensor(input,recv_rank, self_rank,dequant_layer = None , recv_layer = None, sortdequant = None,split = 0,bits = 0):
...
def make_dictions(client_train_settings,client_settings,server_train_settings_list,server_settings_list,args,model_list,devices,tensor_size):
    ...
    client_settings['send_rank'] = 1
    client_settings['recv_rank'] = 3
