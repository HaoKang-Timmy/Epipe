...
from my_pipe import dist_gpipe_nlp, Reshape1, Reshape2, nlp_sequential
...
from my_pipe.distributedlayers.distributed_layers import (
    ForwardSendLayers,
