...
from utils import accuracy,Reshape1,QuantizationLayer,DequantizationLayer,Fakequantize,TopkLayer,Topk_quantization
...
def main_worker(rank,process_num,args):
    ...
    train_loader = torch.utils.data.DataLoader(
        trainset, batch_size=args.batches, shuffle=False, num_workers=12, drop_last=True, sampler=train_sampler,pin_memory=True,
    )
...
#     pass
    ...
    optimizer = torch.optim.SGD([{"params":layer1.parameters()},{"params":layer2.parameters()},{"params":layer3.parameters()}],lr = args.lr,weight_decay = 1e-4)
